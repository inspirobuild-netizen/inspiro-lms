...
await app.register(import('./modules/payments/gateway/gateway.routes.js'), { prefix: '/api/v1' });
...
await app.register(import('./modules/enrollment/enrollment.routes.js'), { prefix: '/api/v1' });
